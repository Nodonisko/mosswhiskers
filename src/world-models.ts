...
function den(p: Paint) {
  ...
  // Fallen mossy log on the left roof, cut end toward the chimney.
  p.poly([[12, 46], [16, 36], [76, 18], [90, 22], [92, 32], [82, 40], [18, 52], [10, 50]], '#51472f');
  p.poly([[16, 44], [20, 38], [76, 22], [88, 24], [88, 32], [78, 38], [20, 48]], '#876b43');
  p.poly([[20, 42], [76, 24], [82, 26], [22, 44]], '#a58b5b');
  p.line(22, 42, 74, 26, '#695535', 2);
  p.line(26, 46, 72, 32, '#705837');
  p.line(38, 34, 46, 16, '#735329', 3);
  p.line(44, 18, 54, 14, '#997038', 2);
  p.ellipse(88, 27, 5, 7, '#51472f');
  p.ellipse(88, 27, 4, 6, '#a58b5b');
  p.ellipse(88, 27, 3, 4, '#705837');
  p.ellipse(88, 27, 1, 2, '#bc9d67');
  leafCluster(p, 30, 38, 10, 6, turf, 0.55);
  leafCluster(p, 52, 30, 12, 6, turf, 0.6);
  leafCluster(p, 70, 26, 8, 5, turf, 0.5);
